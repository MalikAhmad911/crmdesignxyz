    ...
    <header className="sticky top-0 z-50 bg-[color:var(--color-bg)] border-b border-[color:var(--color-border-soft)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-5 lg:px-8 h-16 grid grid-cols-[auto_1fr_auto] items-center gap-3 sm:gap-6">
        ...
        <div className="hidden xl:flex items-center gap-2 justify-self-end">
          ...
          <a href="/signin" className="text-sm px-3.5 py-2 rounded-full bg-[color:var(--color-brand)] text-white hover:bg-[color:var(--color-brand-hover)] whitespace-nowrap">Start free trial</a>
        </div>
        <div className="flex items-center gap-2 justify-self-end xl:hidden">
          <a href="/signin" className="hidden sm:inline-flex text-xs sm:text-sm px-3 sm:px-3.5 py-2 rounded-full bg-[color:var(--color-brand)] text-white hover:bg-[color:var(--color-brand-hover)] whitespace-nowrap">Start free</a>
